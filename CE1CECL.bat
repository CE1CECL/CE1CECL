...
IF "0" == "0" GOTO UNINSTALL-Microsoft.Cryptographic.Provider.Development.Kit..CPDK..Version.8.0.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.0.26100.1..released.May.2024..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.0.26100.1591..released.September.18..2024..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.0.26100.1882..released.October.14..2024..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.0.26100.2161..released.November.4..2024..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.0.26100.2454..released.November.27..2024..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.0.26100.3323..released.March.14..2025..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.0.26100.4202.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.0.26100.6584.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.10.1.22621.2428..released.October.24..2023..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.8..English.only..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.8.1..English.only..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.8.1.Update..English.only..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.1507.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.1511.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.1607.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.1703.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.1709.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.1803.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.1809.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.1903.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.10..version.2004.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.11..version.21H2.exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.11..version.22H2..10.0.22621.382..released.May.24..2022..exe 
...
IF "0" == "0" GOTO UNINSTALL-WDK.for.Windows.Server.2022.exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..10.0.10240..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..10.0.10586.212..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..10.0.14393.795..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..10.0.15063.468..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..10.0.16299.91..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..version.1803..10.0.17134.12..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..version.1809..10.0.17763.0..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..version.1903..10.0.18362.1..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK..version.2004..10.0.19041.0..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.10.SDK.version.2104..10.0.20348.0..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.8.1.SDK.exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.8.SDK.exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.20348.3330..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.22000.194..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.22621.1778..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.22621.2428..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.22621.5040..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.22621.755..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.26100.1742..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.26100.3323..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.26100.3916..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.26100.4188..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.26100.4654..exe 
...
IF "0" == "0" GOTO UNINSTALL-Windows.SDK.for.Windows.11..10.0.26100.4948..exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.1507.exe" /fo csv | find /i "WDK.for.Windows.10..version.1507.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.1507.exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.1511.exe" /fo csv | find /i "WDK.for.Windows.10..version.1511.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.1511.exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.1607.exe" /fo csv | find /i "WDK.for.Windows.10..version.1607.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.1607.exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.1703.exe" /fo csv | find /i "WDK.for.Windows.10..version.1703.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.1703.exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.1709.exe" /fo csv | find /i "WDK.for.Windows.10..version.1709.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.1709.exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.1803.exe" /fo csv | find /i "WDK.for.Windows.10..version.1803.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.1803.exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.1809.exe" /fo csv | find /i "WDK.for.Windows.10..version.1809.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.1809.exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.1903.exe" /fo csv | find /i "WDK.for.Windows.10..version.1903.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.1903.exe 
...
tasklist /fi "ImageName eq WDK.for.Windows.10..version.2004.exe" /fo csv | find /i "WDK.for.Windows.10..version.2004.exe" 
IF "0" == "0" GOTO INSTALL-WDK.for.Windows.10..version.2004.exe 
...
tasklist /fi "ImageName eq Windows.10.SDK..10.0.10586.212..exe" /fo csv | find /i "Windows.10.SDK..10.0.10586.212..exe" 
IF "0" == "0" GOTO INSTALL-Windows.10.SDK..10.0.10586.212..exe 
...
tasklist /fi "ImageName eq Windows.10.SDK..10.0.14393.795..exe" /fo csv | find /i "Windows.10.SDK..10.0.14393.795..exe" 
IF "0" == "0" GOTO INSTALL-Windows.10.SDK..10.0.14393.795..exe 
...
tasklist /fi "ImageName eq Windows.10.SDK..10.0.15063.468..exe" /fo csv | find /i "Windows.10.SDK..10.0.15063.468..exe" 
IF "0" == "0" GOTO INSTALL-Windows.10.SDK..10.0.15063.468..exe 
...
tasklist /fi "ImageName eq Windows.10.SDK..10.0.16299.91..exe" /fo csv | find /i "Windows.10.SDK..10.0.16299.91..exe" 
IF "0" == "0" GOTO INSTALL-Windows.10.SDK..10.0.16299.91..exe 
...
tasklist /fi "ImageName eq Windows.10.SDK..version.1803..10.0.17134.12..exe" /fo csv | find /i "Windows.10.SDK..version.1803..10.0.17134.12..exe" 
IF "0" == "0" GOTO INSTALL-Windows.10.SDK..version.1803..10.0.17134.12..exe 
...
tasklist /fi "ImageName eq Windows.10.SDK..version.1809..10.0.17763.0..exe" /fo csv | find /i "Windows.10.SDK..version.1809..10.0.17763.0..exe" 
IF "0" == "0" GOTO INSTALL-Windows.10.SDK..version.1809..10.0.17763.0..exe 
...
tasklist /fi "ImageName eq Windows.10.SDK..version.1903..10.0.18362.1..exe" /fo csv | find /i "Windows.10.SDK..version.1903..10.0.18362.1..exe" 
IF "0" == "0" GOTO INSTALL-Windows.10.SDK..version.1903..10.0.18362.1..exe 
...
tasklist /fi "ImageName eq Windows.10.SDK..version.2004..10.0.19041.0..exe" /fo csv | find /i "Windows.10.SDK..version.2004..10.0.19041.0..exe" 
IF "0" == "0" GOTO INSTALL-Windows.10.SDK..version.2004..10.0.19041.0..exe 
...
tasklist /fi "ImageName eq Windows.SDK.for.Windows.11..10.0.22000.194..exe" /fo csv | find /i "Windows.SDK.for.Windows.11..10.0.22000.194..exe" 
IF "0" == "0" GOTO INSTALL-Windows.SDK.for.Windows.11..10.0.22000.194..exe 
